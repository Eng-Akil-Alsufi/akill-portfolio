  ...
  return (
    <div className={`min-h-screen bg-background text-foreground ${isRtl ? 'rtl' : 'ltr'}`}>
      ...
      <div className={`fixed bottom-8 ${isRtl ? 'left-8' : 'right-8'} z-[100]`}>
        <div 
          className={`flex items-center bg-background/90 backdrop-blur-md border border-primary/30 rounded-full shadow-xl lang-switcher-expand overflow-hidden group hover:border-primary animate-glow hover:animate-none hover:shadow-[0_0_20px_rgba(0,214,255,0.4)] ${isLangExpanded ? 'max-w-[220px] px-4' : 'max-w-[60px] px-0'}`}
          style={{ height: '60px' }}
        >
          <button
